...
#define HYUNDAI_V1_NAME "hyundai  V1"

typedef struct SubGhzProtocolDecoderHyundaiv1 SubGhzProtocolDecoderHyundaiv1;

extern const SubGhzProtocol hyundai_v1_protocol;
