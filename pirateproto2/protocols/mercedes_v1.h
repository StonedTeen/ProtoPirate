...
#define MERCEDES_V1_NAME "mercedes  V1"

typedef struct SubGhzProtocolDecoderMercedesv1 SubGhzProtocolDecoderMercedesv1;

extern const SubGhzProtocol mercedes_v1_protocol;
