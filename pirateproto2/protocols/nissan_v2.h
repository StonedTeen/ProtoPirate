...
#define NISSAN_V2_NAME "nissan  V2"

typedef struct SubGhzProtocolDecoderNissanv2 SubGhzProtocolDecoderNissanv2;

extern const SubGhzProtocol nissan_v2_protocol;
